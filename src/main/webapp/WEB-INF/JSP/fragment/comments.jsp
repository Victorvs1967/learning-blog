<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" trimDirectiveWhitespaces="true"%>
	...
	<div class="media-object comment-item">
		...
		<div class="media-object-section">
			...
			<p>Vestibulum fringilla pede sit amet augue. Phasellus volutpat, metus eget egestas mollis, lacus lacus blandit dui, id egestas quam mauris
				ut lacus. Sed aliquam ultrices mauris.</p>
			<p class="meta">
	...
	<div class="media-object comment-item">
		...
		<div class="media-object-section">
			...
			<p>Quisque ut nisi. In hac habitasse platea dictumst. Pellentesque posuere. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem.
				Vestibulum fringilla pede sit amet augue. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, quis gravida magna mi a libero.</p>
			<p class="meta">
