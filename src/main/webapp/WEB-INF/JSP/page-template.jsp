	...
	<div class="row">
		...
		<div class="small-6 medium-4 columns">
			<ul id="mobile-category-menu"
				class="categories dropdown menu align-right hide-for-large"
				data-dropdown-menu>
	...
	<footer class="footer">
		<div class="row">
			...
			<div class="small-12 medium-12 large-3 columns">
				...
				<p class="about subheader">A blog is a discussion or
					informational site published on the World Wide Web consisting of
